...
export const GoogleGeminiEffect = ({
    ...
    return (
        (<div className={cn("sticky top-64", className)}>
            <p className="text-lg md:text-5xl font-semibold bg-gradient-to-r from-yellow-300 via-orange-100  to-yellow-600  bg-clip-text pb-4 mt-10 text-center  text-transparent">
        ...
        works!`}
            ...
            {/* <div className="w-full h-[890px] -top-60 md:-top-40  flex items-center justify-center bg-red-transparent absolute ">
                <button
                    ...
                    className="font-bold   rounded-full md:px-6 md:py-2 px-2 bg-yellow-200  py-1 md:mt-24 mt-8 z-30 md:text-base text-black text-xs  w-fit mx-auto ">
                    REGISTER
                </button>
            </div> */}
            <svg
